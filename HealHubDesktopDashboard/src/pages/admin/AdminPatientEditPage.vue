...
<template>
  <div>
    <div class="flex items-start justify-between gap-4">
      <div>
        <div class="text-xl font-semibold hh-title">Edit patient</div>
        <div class="text-sm hh-muted">Update patient information</div>
      </div>
      <div class="flex items-center gap-2">
        <router-link
          class="hh-btn px-3 py-2 text-sm"
          :to="`/admin/patients/${route.params.patientId}`"
        >
          Cancel
        </router-link>
      </div>
