  ...
  <div class="page">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <h1 class="page-heading">Add New Doctor</h1>
        <p class="page-sub">Fill in the details below to register a new doctor account.</p>
      </div>
    </div>

    <form class="form-layout" @submit.prevent="createDoctor" novalidate>
      ...
      <div class="form-section">
        <div class="section-head">
          ...
          <div>
            ...
            <div class="section-sub">Login email and password for the doctor</div>
          </div>
        </div>
        ...
        <div class="fields-grid">
          ...
          <div class="field">
            ...
            <div class="input-wrap">
              ...
              <input id="email" v-model="form.email" type="email" class="finput finput--icon" placeholder="doctor@hospital.org" autocomplete="email" required />
            </div>
          </div>
        ...
        <div class="fields-grid">
          ...
          <div class="field">
            ...
            <div class="input-wrap">
              ...
              <input id="full_name" v-model="form.full_name" class="finput finput--icon" placeholder="Dr. Jane Smith" required />
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="input-wrap">
              ...
              <input id="specialization" v-model="form.specialization" class="finput finput--icon" placeholder="e.g. Cardiologist" required />
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="input-wrap">
              ...
              <input id="qualification" v-model="form.qualification" class="finput finput--icon" placeholder="e.g. MBBS, MD (optional)" />
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="input-wrap">
              ...
              <input id="phone" v-model="form.phone" type="tel" class="finput finput--icon" placeholder="+1 (555) 000-0000" required />
            </div>
          </div>
      ...
      <div class="form-actions">
        <router-link class="btn-ghost" to="/admin/doctors">Cancel</router-link>
